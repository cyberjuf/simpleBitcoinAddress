...
)
{
	...
	div_bn = BN_new();
	rem_bn = BN_new();
	BN_bin2bn((const unsigned char*)source, source_size, x);
...
)
{
	...
	format_output =(char*) malloc(required_fixed_output_size + 1);
